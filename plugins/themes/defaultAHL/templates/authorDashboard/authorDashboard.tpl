...
<div id="submissionWorkflow" class="pkp_submission_workflow">
	...
	<div id="stageTabs" class="pkp_controllers_tab">
		<ul>
			<li><a href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.authorDashboard.AHLAuthorDashboardTabHandler" op="metadata" submissionId=$submission->getId()}">Metadata</a></li>
			<li><a href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.authorDashboard.AHLAuthorDashboardTabHandler" op="attachedFiles" submissionId=$submission->getId()}">Attached Files</a></li>
			<li><a href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.authorDashboard.AHLAuthorDashboardTabHandler" op="preReview" submissionId=$submission->getId()}">Pre-review</a></li>
			{foreach from=$workflowStages item=stage}
				{if $stage.id > 1}
