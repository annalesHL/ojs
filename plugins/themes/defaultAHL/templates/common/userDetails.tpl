 ...
 *   $emailNotRequired: Whether or not the country select is a required field
...
{fbvFormArea id="userDetails"}
	...
	{if !$disableEmailSection}
		{fbvFormSection title="about.contact"}
			{if $emailNotRequired}
				{fbvElement type="text" label="user.email" id="email" value=$email maxlength="90" size=$fbvStyles.size.MEDIUM}
			{else}
