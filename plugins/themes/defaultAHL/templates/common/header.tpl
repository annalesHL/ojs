{**
 * plugins/themes/defaultAHL/templates/frontend/components/header.tpl
 *
 * SAN
 *
...
{include file="common/headerHead.tpl"}
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}" dir="{$currentLocaleLangDir|escape|default:"ltr"}">
  ...
  {* Backend primary site navigation *}
  <nav>
    {include file="common/backendPrimaryNavMenu.tpl"}
  </nav>
  ...
  <div class="pkp_structure_page">
    ...
    <header class="pkp_structure_head" id="headerNavigationContainer" role="banner">
      <div class="pkp_head_wrapper">
        ...
        <div class="pkp_site_name_backend_wrapper">
        ...
        {if $currentContext}
          <nav id="pkp_content_nav" class="pkp_navigation_primary_row navDropdownMenu" aria-label="{translate|escape key="common.navigation.site"}">
            <div class="pkp_navigation_primary_wrapper">
              ...
              {include file="frontend/components/primaryNavMenu.tpl" subMenu=false}
             </div>
          </nav>
        {/if}
    ...
    <div class="pkp_structure_content{if $hasSidebar} has_sidebar{/if}">
      <div id="pkp_content_main" class="pkp_structure_main pkp_structure_backend" role="main">
